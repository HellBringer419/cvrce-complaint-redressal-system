...
<html>
	...
	<div class="CompContainer" align="center" id="CompContainer">
		...
		$sql="SELECT  `description`,  `is_resolved`, `created_at`, `title`,  `position_seen`, `mentor_seen` FROM `complaints` WHERE `type` = 0 AND user_id =". $regid."";
...
<td>&nbsp;</td>
		    ...
		    echo "<script> alert(' no OTHERS complaints ') </script>" ;
		}
		?>
