...
<html>
	...
	<div class="background">
		...
		if(isset($_SESSION['username'])) {
		    ...
		    else if($_SESSION['type'] == 'ga faculty') {
	...
	<div class="CompContainer" align="center" id="CompContainer">
		...
		$sql="SELECT  `description`,  `is_resolved`, `created_at`, `title`,  `position_seen`, `mentor_seen` FROM `complaints` WHERE `type` = 4 AND user_id =". $regid."";
...
<td>&nbsp;</td>
		    ...
		    echo "<script> alert(' no exam complaints ') </script>" ;
		}
		?>
