...
<html>
	...
	<div class="CompContainer" align="center" id="CompContainer">
		...
		<h3> Placement related complaints </h3>
		<tr class="header">
		    <th> Title </th>
		    <th> Description </th>
		...
		$sql="SELECT  `description`,  `is_resolved`, `created_at`, `title`,  `position_seen`, `mentor_seen` FROM `complaints` WHERE `type` = 3 AND user_id =". $regid."";
...
<td>&nbsp;</td>
		    ...
		    echo "<script> alert(' no placement complaints ') </script>" ;
		}
		?>
